...
Normalized episode scores (reward sum scaled to [0, 1] using `compute_episode_return_bounds` in `models.py`, aligned with server `construct_reward`), synthetic problems:
